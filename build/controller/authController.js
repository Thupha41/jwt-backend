...
var handleRegister = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, email, phone, password, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, email = _req$body.email, phone = _req$body.phone, password = _req$body.password;
        ...
        case 13:
          ...
          console.error("Error in handleRegister:", _context.t0);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _auth["default"].login(req.body);
        case 3:
          data = _context2.sent;
          if (!(data && +data.EC !== 1)) {
            _context2.next = 6;
