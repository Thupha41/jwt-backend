...
var checkUserExists = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(userEmail, userPhone) {
    var user;
  ...
  return function checkUserExists(_x2, _x3) {
...
_defineProperty(AuthService, "register", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return checkUserExists(rawUserData.email, rawUserData.phone);
        case 3:
          user = _context3.sent;
        ...
        case 10:
          _context3.next = 12;
          return hashUserPassword(rawUserData.password);
        case 12:
...
_defineProperty(AuthService, "login", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return checkUserExists(rawUserData.valueLogin, rawUserData.valueLogin);
        case 3:
          user = _context4.sent;
          console.log(">>> check user", user);
          if (!user) {
          ...
          checkPw = checkPassword(rawUserData.password, user.password);
          if (!checkPw) {
            _context4.next = 9;
            break;
          }
