...
var _config = require("../configs/config.mysql");
...
var SALT_ROUNDS = parseInt(process.env.SALT_ROUNDS, 10) || 10;

// Hashes the password asynchronously
var hashPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(userPassword) {
    var salt, hash;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _bcryptjs["default"].genSalt(SALT_ROUNDS);
        case 3:
          salt = _context.sent;
          _context.next = 6;
          return _bcryptjs["default"].hash(userPassword, salt);
        case 6:
          hash = _context.sent;
...
var createNewUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(email, password, username) {
    var hashPass, user;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 10:
          ...
          console.error("Error creating new user:", _context2.t0);
        case 13:
        case "end":
...
var getListUser = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var userById, roles1, roles, users;
      ...
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          return _index["default"].Role.findAll({
            ...
            include: [{
              model: _index["default"].Permission
            }],
            raw: true,
            nest: true
          });
        case 5:
          roles1 = _context3.sent;
          _context3.next = 8;
          return _index["default"].Permission.findAll({
            include: {
              model: _index["default"].Role,
              where: {
                id: 1
        ...
        case 21:
          ...
          console.error("Error getting list of user:", _context3.t0);
        case 24:
        case "end":
  ...
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(userId) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 4:
          userById = _context5.sent;
          console.log(">> CHECK USER FIND ONE", userById, ">>>> CHECK ID", userId);
          return _context5.abrupt("return", userById);
        case 9:
          _context5.prev = 9;
          _context5.t0 = _context5["catch"](0);
          console.error("Error getting user by id", _context5.t0);
        case 12:
        case "end":
...
var editUser = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(email, username, id) {
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 5:
          ...
          console.error("Error editing user", _context6.t0);
        case 8:
        case "end":
  ...
  return function editUser(_x7, _x8, _x9) {
